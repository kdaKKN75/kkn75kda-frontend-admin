    ...
    return (
        <div className="relative">
            ...
            <div
                ...
                className={`absolute right-0 mt-4 flex w-55 flex-col border border-stroke bg-white shadow-default rounded-md ${
            ...
            >
                ...
                <button className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-red-500 lg:text-base">
                    <svg
                        className="fill-current"
                        width="22"
                        height="22"
